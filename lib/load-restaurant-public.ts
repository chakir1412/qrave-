...
const RESTAURANT_PUBLIC_SELECT =
  "id, slug, name, template, accent_color, primary_color, logo_url, splash_image_url, splash_media_url, splash_media_type, guest_note, adresse, stadt, stadtbezirk, telefon, email, whatsapp, instagram, maps_url, website, oeffnungszeiten, aktiv, published";
