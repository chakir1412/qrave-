...
const EVENT_SELECT =
  "id,session_id,event_type,created_at,stunde,monat,tisch_nummer,item_name,kategorie,tier,restaurant_id,item_price,item_tags,beverage_subcategory,price_bucket";
