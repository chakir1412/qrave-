    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <h3 className="font-serif text-[1.3rem] font-normal" style={{ color: "#1a1916" }}>
              Meine Liste
            </h3>
            <button
              type="button"
                ...
                {cart.map(({ item, qty }) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-[0.84rem]" style={{ color: "#1a1916" }}>
                        {item.name}
                      </div>
                      <div className="text-[0.73rem]" style={{ color: "#b8966a" }}>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[0.82rem] font-semibold min-w-[16px] text-center" style={{ color: "#1a1916" }}>
                        {qty}
                      </span>
                      <button
                        type="button"
          ...
          {cart.length > 0 && (
            <div className="p-4 border-t" style={{ borderColor: "#e8e4dc" }}>
              <div className="flex justify-between font-semibold text-[0.9rem] mb-2" style={{ color: "#1a1916" }}>
                <span>Gesamt (ca.)</span>
                <span className="font-serif text-[1.1rem]" style={{ color: "#b8966a" }}>
